...
setup(
    ...
    url='https://github.com/abnerjacobsen/tinydb-jsonorm',
    ...
    keywords=[
        'TinyDB ORM jsonmodels Json',
    ],
    install_requires=[
        'tinydb>=3.2.0', 'tinydb-serialization>=1.0.3', 'tinydb-smartcache>=1.0.2', 'jsonmodels>=2.1.2'
    ],
    extras_require={
        # eg:
        #   'rst': ['docutils>=0.11'],
